  ...
  var theHTML =
    '<div id="mdl-datepicker-div-' + this[0].id + '" class="mdl-cell mdl-cell--2-col mdl-card mdl-shadow--2dp mdl-js-layout mdl-js-ripple-effect mdl-datepicker mdl-datepicker-hide">'+
      '<div class="header-background mdl-datepicker">'+
        ...
        '<div id="mdl-datepicker-selected-date-' + this[0].id + '" class="mdl-typography--headline mdl-datepicker"></div>'+
      '</div>'+
      ...
      '<div id="mdl-datepicker-calendar-container-' + this[0].id + '" class="mdl-datepicker">'+
        '<table id="mdl-datepicker-daysofweek-' + this[0].id + '" class="mdl-datepicker mdl-typography--regular mdl-datepicker-calendar a7-w100">'+
          '<tr class="a7-cal-weekday">'+
          ...
          '</tr>'+
        '</table>'+
        '<table id="mdl-datepicker-calendar-' + this[0].id + '" class="mdl-typography--regular mdl-datepicker-calendar mdl-datepicker a7-w100 a7-day-content">'+
        '</table>'+
